    ...
    return {
        init: function () {
            ...
            !function () {
                                    ...
                                    i && ($(e).on("select2:unselect", (function (t) {
                                        ...
                                        i.on("kt.menu.dropdown.hide", (function (t) {
                                            if ("1" === e.getAttribute("data-multiple-unselect"))
                                                return e.removeAttribute("data-multiple-unselect"),
                                                    !1
                                        }
                                        )))
                            }
                ...
                r(),
                "undefined" != typeof countUp && (!1 === t && (r(),
                ...
                function () {
                    ...
                    (e || 0 !== e.length) && e.forEach((function (e) {
                        "1" !== e.getAttribute("data-kt-initialized") && (o(e),
...
var KTDialer = function (e, t) {
    ...
    if (e) {
        var i = {
            ...
            , d = function (e) {
                return e = parseFloat(e).toFixed(n.options.decimals),
    ...
    , KTDrawer = function (e, t) {
        ...
        if (null != e) {
            var i = {
                ...
                , u = function () {
                    ...
                    !0 === KTUtil.hasClass(n.element, n.options.baseClass + "-on") && "on" === String(document.body.getAttribute("data-kt-drawer-" + n.name + "-")) ? n.shown = !0 : n.shown = !1,
                        !0 === m("activate") ? (KTUtil.addClass(n.element, n.options.baseClass),
                            ...
                            e && (KTUtil.css(n.element, "width", e, !0),
                                n.lastWidth = e),
                            t && (KTUtil.css(n.element, "height", t, !0),
                                n.lastHeight = t),
                ...
                , p = function () {
                    var e = m("height");
                    return "auto" === e && (e = KTUtil.css(n.element, "height")),
                        e
                };
    ...
    , KTMenu = function (e, t) {
        ...
        if (null != e) {
            var i = {
                ...
                , a = function (e) {
                    e || (e = n.triggerElement),
                        !0 !== m(e) && ("dropdown" === v(e) ? y(e) : "accordion" === v(e) && A(e),
                            KTUtil.data(e).set("type", v(e)))
                }
                , l = function (e) {
                    e || (e = n.triggerElement),
                        !1 !== m(e) && ("dropdown" === v(e) ? w(e) : "accordion" === v(e) && x(e))
                }
                , s = function (e) {
                    if (!1 !== f(e)) {
                        var t = g(e);
                ...
                , y = function (e) {
                    if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.show", e)) {
                        ...
                        null !== a && a >= o && (o = a + 1),
                            ...
                            !0 === L(e, "overflow") ? (document.body.appendChild(t),
    ...
    return {
        init: function () {
            ...
            (e = document.querySelector("#kt_app_sidebar"),
                ...
                null !== e) && (r && (o = KTToggle.getInstance(r),
                    a = KTMenu.getInstance(t),
                    null !== o && (o.on("kt.toggle.change", (function () {
